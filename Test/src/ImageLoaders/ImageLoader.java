...
public class ImageLoader {
    ...
    public Image getImage(String name) {
        ...
        for (String cext : extensions) {
            ext = cext;
            if (new File(basePath + "." + cext).exists()) {
                break;
            }
            ext = "";
        }
    ...
    /**
     * Release all resources used by Images WARNING: This will eventually
     * destroy Images used by other objects, e.g. SpriteSheets
     */
